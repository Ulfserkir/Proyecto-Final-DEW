        ...
        <section className="contenedor-blog">
          <div className="blog">
            <article className="entrada">
              ...
              <a href="entrada.js" className="btn max-width-30">Leer</a>
            </article>
          ...
          <aside>
            ...
            <ul>
              <li><a href="entrada.js">Guía de Colores</a></li>
              <li><a href="entrada.js">Nuevos Modelos</a></li>
              <li><a href="entrada.js">Guía para diseño de interiores</a></li>
              <li><a href="entrada.js">Guía para diseño de exteriores</a></li>
            </ul>
          </aside>
        </section>
      </main>
